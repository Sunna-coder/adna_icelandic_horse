...
This project directly addresses the MSCA-PF programme's core objectives of fostering scientific excellence, supporting researchers at a critical career stage, and enabling knowledge transfer between institutions and disciplines. Dr Ebenesersdóttir brings world-class expertise in ancient DNA methodology and Icelandic population genomics, developed through her work at the University of Iceland and through an ongoing collaboration with deCODE Genetics; the host laboratory of Prof. Tom Gilbert at the Centre for Evolutionary Hologenomics (CEH), GLOBE Institute, University of Copenhagen provides a world-leading environment in ancient and environmental genomics with the computational and methodological infrastructure required for this project. The fellowship will create genuine bidirectional knowledge transfer: Dr Ebenesersdóttir will acquire new skills in [CEH-specific methods and approaches], while contributing her unique aDNA protocols, optimised for degraded Icelandic material, and her exclusive access to Iceland's archaeological horse specimens — resources that have been entirely absent from the field of ancient horse genomics.

[Claude comment: The original framing of knowledge transfer was built around Orlando as host (horse imputation, trait genetics). Now that Tom Gilbert is the primary host, please describe what you expect to gain from CEH/Gilbert's group specifically — e.g., particular methods, data resources, or scientific expertise — so this section can be written accurately. What is the scientific complementarity between your background and what Gilbert's lab offers?]

The project also involves a key external collaboration with Prof. Ludovic Orlando (Centre for Anthropobiology and Genomics of Toulouse, CAGT), whose laboratory has developed the largest ancient horse imputation reference panel in the world (>900 genomes) and whose expertise in horse genomics is central to the analytical strategy of this project. Prof. Orlando and Dr Ebenesersdóttir are already active co-authors on a manuscript currently under review (Ahmed et al.).
...
Following specimen selection at the National Museum of Iceland, samples will be transported to the host institution (CEH, University of Copenhagen) for all aDNA laboratory work. Export of archaeological specimens for scientific analysis is subject to permission from the Icelandic cultural heritage authority (Minjasafnanefnd); this permission is not anticipated to present an obstacle, as a direct precedent exists: the 22 Icelandic horse specimens analysed by Pálsdóttir et al. were exported to Norway for aDNA analysis under the same framework. We will initiate the export application in parallel with the fellowship submission.

All aDNA work will be carried out at the CEH ancient DNA laboratory, University of Copenhagen, using silica-based extraction protocols developed by the applicant and optimised for highly degraded Icelandic skeletal material — the same protocols used to generate 201 ancient Icelandic human genomes (Ebenesersdóttir et al., *Science* 2018; manuscript in preparation). The CEH facility is physically isolated from areas where modern DNA is handled and adheres to strict international contamination-control standards. In our experience with Icelandic skeletal material, this approach reliably recovers endogenous DNA from specimens over 1,000 years old.
...
Raw reads will be processed using the aDNA pipeline developed by the applicant (adapter trimming with AdapterRemoval2; mapping to the horse reference genome EquCab3 with BWA; duplicate removal with Picard MarkDuplicates; base quality rescaling with mapDamage2). Sex will be estimated from X:Y chromosome read ratios; contamination will be assessed using mtDNA and nuclear methods.
...
**Second**, the Icelandic horse is a globally exceptional model system. It is one of the only domestic animals in the world with a clean, uninterrupted, and legally enforced population history from the medieval period to the present, free from admixture with outside populations. This makes it uniquely suited to quantifying the genomic consequences of isolation, founder effects, and drift — questions that are central to conservation biology, island biogeography, and the evolutionary biology of domestic species, but which can rarely be addressed with such clarity. Fages et al. (2019, *Cell*) demonstrated a major loss of genetic diversity accompanying modern breed formation in horses globally; the Icelandic horse, whose breed history is completely documented, allows us to pinpoint precisely when and why such losses occurred.

**Third**, the project combines complementary methodological strengths that have not previously been brought to bear on the Icelandic horse: (i) aDNA extraction and sequencing protocols specifically optimised for degraded Icelandic skeletal material, developed by the applicant and deployed via an ongoing collaboration with deCODE Genetics; (ii) the computational and analytical infrastructure of the host laboratory at CEH, University of Copenhagen; and (iii) the ancient horse imputation reference panel and horse genomics expertise of the Orlando laboratory (CAGT, Toulouse), contributing through an established scientific collaboration. No previous study has combined all three resources; together, they make the project feasible and scientifically powerful.

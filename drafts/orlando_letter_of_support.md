...
Dr Ebenesersdóttir brings precisely the expertise needed to realise this project: she and her team at deCODE Genetics have developed and applied aDNA extraction and sequencing protocols specifically optimised for degraded Icelandic skeletal material, achieving results that are directly applicable to horse remains. Her landmark study of 88 ancient Icelandic human genomes (*Science*, 2018) demonstrates the feasibility of the proposed approach. My laboratory will contribute the horse genomics expertise and the comparative reference panel required for the imputation and population-level analyses.
...
Founding Director, Centre for Anthropobiology and Genomics of Toulouse (CAGT)

...
***[NEW — recommend rewriting in your own words; no Rannís equivalent, since Orlando as MSCA host supervisor is not part of that grant at all]***

**Supervisor**: Prof. Ludovic Orlando is a CNRS Silver Medal laureate and founding director of the Centre for Anthropobiology and Genomics of Toulouse (CAGT), University of Toulouse. He is a world leader in ancient horse genomics, having published foundational horse domestication studies in *Nature*, *Science*, and *Cell*, and has developed the reference panel of >900 modern and ancient horse genomes that underpins this project's imputation strategy. He is co-corresponding author, with the applicant as co-author, on Ahmed et al. (under review, *Science*), an active, ongoing collaboration.

**Training programme for the fellow**: the applicant brings deep expertise in ancient DNA extraction and human population genomics, but has not previously applied these methods to a non-human, breed-structured population with a large multi-breed comparative reference panel. Under Prof. Orlando's supervision, key learning objectives are: applying the horse-specific imputation reference panel and its associated QC framework; admixture graph modelling in a multi-breed context; demographic modelling methods (PSMC, SMC++) not previously used in her human work; and horse-specific functional/trait genetics, an entirely new domain for the applicant.

**Two-way knowledge transfer**: the applicant brings to CAGT aDNA extraction protocols optimised for highly degraded sub-Arctic skeletal material, direct access to Icelandic horse specimens through the National Museum of Iceland and deCODE Genetics, and applied experience with GLIMPSE2-based imputation and IBD analysis from her human population genomics work.

**Secondment**: no secondment is planned. The Iceland-based phase of the project constitutes fieldwork and sampling at the applicant's own institution, not a placement at a third organisation.
